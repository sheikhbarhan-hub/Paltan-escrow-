...
Single-file. Colored inline buttons via MTProto. Full escrow features + admin panel.
"""
...
# ---- Colored button style (MTProto layer 181+) ----
try:
...
def KB(text, data, color="primary"):
    ...
    if s is not None:
        try:
            ...
            pass
    return KeyboardButtonCallback(**kw)
...
def admin_menu():
    return markup([
        ...
        [KB("🚫 BAN USER", "adm_ban", "danger"), KB("✅ UNBAN USER", "adm_unban", "danger")],
    ...
    try:
        ...
        if data == "my_status":
            ...
            await event.edit("❤ <b>All deals info !</b>\n━━━━━━━━━━━━━━━━━━━━\nSelect the deal below for info :",
                             parse_mode="html", buttons=markup(rows))
            ...
            if d:
                ...
                await event.edit(text, parse_mode="html",
                                 buttons=markup([[KB("⬅ Back", "my_deals", "primary")]]))
...
async def cmd_rd(e):
    ...
    if not val:
        await e.reply("❌ Invalid code.")
        return
    set_setting(f"code_{code}", "0")  # mark used
...
async def startup_notify():
    msg = (
        ...
        "🔹 Admin Panel: ✅ Ready\n"
        f"🔹 Fee: {FEE_PERCENT}%\n"
        f"🔹 Colored Buttons: {'✅ ON' if STYLE_OK else '❌ OFF (update Telethon)'}\n"
        "━━━━━━━━━━━━━━━━━━━━\n"
