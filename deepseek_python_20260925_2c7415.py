...
async def start(m: Message):
    ...
    await m.answer(message, reply_markup=main_menu())
...
async def myid(m: Message):
    ...
    await m.answer(f"Your Telegram ID: <code>{user_id}</code>")
...
async def close_deal(m: Message):
    ...
    deal_text = original_message.text or original_message.caption or ""
